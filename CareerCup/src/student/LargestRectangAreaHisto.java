 ...
 */
public class LargestRectangAreaHisto {
	...
	public static int getMaxArea(int hist[], int n) {
		...
		int area_with_top = Integer.MIN_VALUE; // To store area with top bar as the smallest bar
		...
		while (i < n) {
			...
			// 'left index'
				...
				tp = s.pop(); // store the top index and remove
