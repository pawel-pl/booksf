			...
			<div id="rightSide" style="float: left; margin-left: 3%;">
				<div class="content">
				    <div class="header" style="margin-left: 0px;">
						<h4><span><spring:message code="customer.edit.titel"/></span></h4>
					    <layout:globalErrors/>
					</div>
					
						<form:form method="POST" action="editCustomer.do" modelAttribute="customer">
					...
					<div class="leftButton"><a href="custListToEdit.do"><img  src="images/btn_wstecz.gif" alt="Back" ></a></div>
				</div>
			</div>
